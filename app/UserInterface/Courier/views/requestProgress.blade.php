...
@section('css')
    ...
    <link href="{{ url('/courier_public/css/star-rating.min.css') }}" media="all" rel="stylesheet" type="text/css" />
@endsection


@section('scripts')
    <script src="{{ url('/courier_public/js/star-rating.min.js') }}" type="text/javascript"></script>
    <script src="{{ url('/courier_public/js/custom-star-rating.js') }}" type="text/javascript"></script>
...
<div id="cancelModal" class="modal fade in" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="POST" action="{{ url('/courier/cancelTransaction') }}">
        {{ csrf_field() }}
