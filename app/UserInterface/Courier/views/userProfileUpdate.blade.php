              ...
              <div class="panel-body">
                <div class="row">
                    ...
                    <table class="table table-user-information">
                      ...
                      <div class="col-md-12 col-lg-12 col-md-offset-3 col-lg-offset-3" align="center" style="padding: 10px">
                        ...
                        <div class="col-md-3 col-lg-3 " align="center" style=""> 
                          <form class="form-horizontal" role="form" method="POST" action="{{ url('/courier/profile/saveId') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                      ...
                      <form class="form-horizontal" role="form" method="POST" action="{{ url('/courier/profile/save') }}">
                        {{ csrf_field() }}
                   ...
                   <div class="panel-footer">
                      <div align="right">
                          <a href="{{ url('/courier/profile') }}" class="btn btn-sm btn-danger"><i class="glyphicon glyphicon-remove-sign"></i> Cancel</a>
